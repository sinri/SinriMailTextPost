     ...
     failure:(void (^)(SMTPMessage*, NSError *))failureCallback
    {
        ...
        dispatch_async(dispatch_get_global_queue(0, 0), ^{
            ...
            if (code != CURLE_OK) {
                ...
                if (self->_failureCallback) self->_failureCallback(self, error);
            }else{
                if (self->_successCallback) self->_successCallback(self);
            }
...
- (CURLcode)send
    {
        ...
        curl_easy_setopt(_handler, CURLOPT_SSL_VERIFYPEER, 0);
